...
const LANG_BADGES: { test: RegExp; code: string; color: string }[] = [
  ...
  { test: /\.(cpp|cc|cxx|hpp|hh|hxx)$/i, code: "C+", color: "#00599c" },
  { test: /\.mm?$/i, code: "OC", color: "#438eff" },
  { test: /\.[ch]$/i, code: "C", color: "#555555" },
  { test: /\.swift$/i, code: "SW", color: "#f05138" },
  { test: /\.zig$/i, code: "ZG", color: "#f7a41d" },
  { test: /\.hs$/i, code: "HS", color: "#5e5086" },
  { test: /\.rb$/i, code: "RB", color: "#cc342d" },
  { test: /\.php$/i, code: "PH", color: "#777bb4" },
  { test: /\.(sh|bash)$/i, code: "SH", color: "#4eaa25" },
  { test: /\.lua$/i, code: "LU", color: "#2c2d72" },
  { test: /\.dart$/i, code: "DT", color: "#0175c2" },
  { test: /\.jl$/i, code: "JL", color: "#9558b2" },
