...
export const SOURCE_EXT =
  /\.(tsx?|jsx?|mts|cts|mjs|cjs|vue|svelte|py|java|kts?|rs|go|scala|sc|cs|fsx?|c|h|cpp|cc|cxx|hpp|hh|hxx|mm?|ml|swift|zig|hs|rb|php|sh|bash|lua|dart|jl|r|nix|jsonc?|wat)$/i;
