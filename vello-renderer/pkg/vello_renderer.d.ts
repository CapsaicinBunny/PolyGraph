...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h8d0a2bd66ba9dad6: (
    a: number,
    b: number,
    c: any,
  ) => [number, number];
  readonly wasm_bindgen__convert__closures_____invoke__h26b056603e6c5143: (
    a: number,
    b: number,
    c: any,
    d: any,
  ) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h189c8dab150afcd2: (
    a: number,
    b: number,
    c: any,
  ) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h189c8dab150afcd2_2: (
    a: number,
    b: number,
    c: any,
  ) => void;
